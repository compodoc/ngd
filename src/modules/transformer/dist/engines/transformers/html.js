...
var HtmlTransformer = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        content = html_dagre_1.html(content);
                        file = path.join(options.output, '/dependencies.html');
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                fs.outputFile(file, content, function (error) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                            ...
                                            case 2:
                                                ...
                                                return [4 /*yield*/, Promise.resolve(file)];
                                            case 3:
                                                _a.sent();
                                                return [2 /*return*/];
                                        }
